...
echo "CREATE USER 'hyungjki'@'localhost' IDENTIFIED BY 'hyungjki';" | mysql -u root
echo "GRANT ALL PRIVILEGES ON wordpress.* TO 'hyungjki'@'localhost' WITH GRANT OPTION" | mysql -u root
path="/var/www/html"
mkdir ${path}
